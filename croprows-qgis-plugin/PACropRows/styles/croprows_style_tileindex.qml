...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="colrow">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="generator">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="colrow"/>
  ...
  <aliases>
    <alias field="col" index="0" name=""/>
    <alias field="row" index="1" name=""/>
    <alias field="colrow" index="2" name=""/>
    <alias field="generator" index="3" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="7536640">
    <columns>
      <column width="-1" hidden="0" type="field" name="col"/>
      <column width="-1" hidden="0" type="field" name="row"/>
      <column width="-1" hidden="0" type="field" name="colrow"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="colrow" expression=""/>
    <default field="generator" expression=""/>
  </defaults>
